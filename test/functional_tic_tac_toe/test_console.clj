(ns functional_tic_tac_toe.test_console
  (:use
    [clojure.test]
    [functional-tic-tac-toe.console]
    [functional-tic-tac-toe.core :only [make-board final-message]]))

(defn fake-println [& args])

;;;like before each in mocha
(use-fixtures :each
